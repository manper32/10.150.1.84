...
a.fila,
b.diagges
from bancoSantander.[dbo].[cob_gestrim] a,
bancoSantander.[dbo].[cob_validacodt] b
...
left join (	select LTRIM(RTRIM(c.indice)) indice
					,d.prioridad
					,count(*) repeticion
			from	bancoSantander.[dbo].[cob_gestrim] c,
					bancoSantander.[dbo].[cob_validacodt] d 
...
queryP_del_P = """
truncate table cbpo_santander.mejor_gestion_dia ;
"""


#query insert PostgreSQL produccion
queryP_in_P ="""
INSERT INTO cbpo_santander.mejor_gestion_dia(
deudor_id
,dia
,indicador
,repeticion
