...
b.indice indi,
a.codemp codep
from Claro.[dbo].[cob_gestrim] a,
Claro.[dbo].[cob_validacodt] b
...
left join (	select LTRIM(RTRIM(c.indice)) indice
					,d.prioridad
					,count(*) repeticion
			from	Claro.[dbo].[cob_gestrim] c,
					Claro.[dbo].[cob_validacodt] d 
...
queryP_del_P = """
delete from cbpo_claro.mejor_gestion
where fecha_gestion::date >= '"""+ li +"';"


#query insert PostgreSQL produccion
queryP_in_P ="""
INSERT INTO cbpo_claro.mejor_gestion(
deudor_id
,mes
,anio
,indicador
...
#cursorP_P.execute(queryP_in_P,anwr[42985])
#conexionP_P.commit()
