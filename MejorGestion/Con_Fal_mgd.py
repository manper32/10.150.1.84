...
a.fila,
b.diagges
from falabella.[dbo].[cob_gestrim] a,
falabella.[dbo].[cob_validacodt] b
...
,d.prioridad
,count(*) repeticion
from falabella.[dbo].[cob_gestrim] c,
falabella.[dbo].[cob_validacodt] d
...
queryP_del_P = """
truncate table cbpo_falabella.mejor_gestion_dia ;
"""


#query insert PostgreSQL produccion
queryP_in_P ="""
INSERT INTO cbpo_falabella.mejor_gestion_dia(
deudor_id
,dia
,indicador
,repeticion
