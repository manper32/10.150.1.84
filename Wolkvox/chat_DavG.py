...
queryP_in_P ="""
INSERT INTO cbpo_davivienda.wolk_chats(
chat_id,
channel,
chat_date,
user_name,
...
user_id,
sentiment,
mark)VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);
"""

##query insert PostgreSQL produccion
queryP_in_P1 ="""
INSERT INTO cbpo_davivienda.wolk_conv(
chat_id,
channel,
from_msg,
from_,
...
msg,
sentiment,
mark)VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s);
"""

##query insert PostgreSQL produccion
queryP_in_P2 ="""
INSERT INTO cbpo_davivienda.wolk_cbot(
id_chat,
channel,
routing_point,
date,
...
cust_query,
chatbot_answer,
mark)VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);
"""

#davivienda garantias
urlchat =   'http://35.202.146.58/ipdialbox/api_reports.php?token=7b69645f6469737472697d2d3230323030393231313631393330&report=chats&'\
            +'date_ini='+yesterday+'&date_end='+today
urlconv =   'http://35.202.146.58/ipdialbox/api_reports.php?token=7b69645f6469737472697d2d3230323030393231313631393330&report=chats_conversations&'\
            +'date_ini='+yesterday+'&date_end='+today
urlcbot =   'http://35.202.146.58/ipdialbox/api_reports.php?token=7b69645f6469737472697d2d3230323030393231313631393330&report=chats_bots&'\
            +'date_ini='+yesterday+'&date_end='+today
