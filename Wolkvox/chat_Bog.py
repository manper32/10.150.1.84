...
queryP_in_P ="""
INSERT INTO cbpo_bogota.wolk_chats(
chat_id,
channel,
chat_date,
user_name,
...
#query insert PostgreSQL produccion
queryP_in_P1 ="""
INSERT INTO cbpo_bogota.wolk_conv(
chat_id,
channel,
from_msg,
from_,
...
#query insert PostgreSQL produccion
queryP_in_P2 ="""
INSERT INTO cbpo_bogota.wolk_cbot(
id_chat,
channel,
routing_point,
date,
...
#cobrando-bogota
urlchat =   'http://35.239.200.142/ipdialbox/api_reports.php?token=7b69645f6469737472697d2d3230323030393135313330383434&report=chats&'\
            +'date_ini='+yesterday+'&date_end='+today
urlconv =   'http://35.239.200.142/ipdialbox/api_reports.php?token=7b69645f6469737472697d2d3230323030393135313330383434&report=chats_conversations&'\
            +'date_ini='+yesterday+'&date_end='+today
urlcbot =   'http://35.239.200.142/ipdialbox/api_reports.php?token=7b69645f6469737472697d2d3230323030393135313330383434&report=chats_bots&'\
            +'date_ini='+yesterday+'&date_end='+today
